    ...
    const fetchTasks = async () => {
        ...
        try {
            const params = new URLSearchParams({
                ...
                limit: itemsPerPage,
                sort: sortOption,
                search: searchQuery.trim(), // ตัดช่องว่างที่ไม่จำเป็น
            ...
            const response = await fetch(`/api/it-job/completedJob?${params.toString()}`);
    ...
    return (
        ...
        >
            ...
            >
                ...
                <span
                    style={{
                        color: theme.mode === "dark" ? "#FFD700" : getColorFromTheme(theme.primaryColor, theme.primaryWeight), // สีฟ้อนเฉพาะ {user.fullName}
                    }}
                >
                    {user.fullName}
                </span>{" "}
...
export default CompletedTasksContent;